...
const MessageBubble = ({ type, content, timestamp }) => {
  ...
  if (isUser) {
    return (
      <div className="flex justify-end mb-1.5 sm:mb-2">
        <motion.div
          className="max-w-[85%] px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl sm:rounded-2xl bg-blue-500 text-white"
  ...
  if (isError) {
    return (
      <div className="flex justify-start mb-1.5 sm:mb-2">
        <motion.div
          className="max-w-[85%] px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl sm:rounded-2xl bg-red-500/20 backdrop-blur-sm border border-red-500/30"
          initial={{ scale: 0.9, opacity: 0 }}
          animate={{ scale: 1, opacity: 1 }}
        >
  ...
  return (
    <div className="flex justify-start mb-1.5 sm:mb-2">
      <motion.div
        className="max-w-[85%] px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl sm:rounded-2xl bg-white/10 backdrop-blur-md border border-white/10"
        initial={{ scale: 0.9, opacity: 0 }}
        animate={{ scale: 1, opacity: 1 }}
      >
